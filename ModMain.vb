...
Module ModMain
    ...
    Declare Auto Function GetWindowLong Lib "user32" (ByVal hWnd As System.IntPtr, ByVal nIndex As Integer) As Long
    Declare Auto Function SetWindowLong Lib "user32" (ByVal hWnd As System.IntPtr, ByVal nIndex As Integer, ByVal dwNewLong As Long) As Long
    ...
    Public ProgressTop As Integer
    Public ProgressLeft As Integer
